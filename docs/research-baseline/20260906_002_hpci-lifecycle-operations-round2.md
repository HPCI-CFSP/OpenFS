...
- future retirement, refresh, or expansion timing: 15 of 27 systems;
...
Future timing remains unverified for 12 systems: Fugaku, Genkai A and B,
Grand Chariot2 CPU, Miyabi C and G, AOBA A and B, the ISM large-memory system,
...
追加調査しました。将来時期は15システム、公開運用情報への経路は25システム、数値を伴う
...
扱いません。将来時期が未確認の12システムはCoverage Gapとして残し、一般的な借入期間など
