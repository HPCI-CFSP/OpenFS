...
- `ARCH-01-U03` **エージェント処理向けCPU / CPUs for agentic workloads** (`partial`)
  ...
  - Evidence sections: TDS-HW1-ARCH-01-U03, TDS-CD16-ARCH-01-AGENTIC-SYSTEM-TRACE, TDS-WC367-ARCH-01-01
...
- `ARCH-02-U01` **製造プロセスと供給 / Processes and production** (`partial`)
  ...
  - Evidence sections: TDS-HW1-ARCH-02-U01, TDS-HW2-ARCH-02-U01, TDS-CD42-ARCH-02-BEYOND2NM-GATE-STACK, TDS-WC369-ARCH-02-01
...
- `ARCH-04-U03` **光接続 / Optical connectivity** (`partial`)
  ...
  - Evidence sections: TDS-HW1-ARCH-04-U03, TDS-WC370-ARCH-04-01
...
- `ARCH-05-U01` **ラック・システム構成 / Rack and system organization** (`partial`)
  ...
  - Evidence sections: TDS-HW1-ARCH-05-U01, TDS-HW3-ARCH-05-U01, TDS-CD10-ARCH-05-U01, TDS-CD11-ARCH-05-U01, TDS-CD12-ARCH-05-U01-U02, TDS-CD13-ARCH-05-U01-U02, TDS-CD14-ARCH-05-U01-U02, TDS-CD3-ARCH-05-VERA-RUBIN-PUBLIC-SYSTEMS, TDS-CD4-ARCH-05-RIKYU-OPERATION, TDS-CD5-ARCH-05-RIKYU-ALLOCATABLE-SCALE, TDS-CD31-ARCH-05-AWS-ALLOCATABLE-AI-SCALE, TDS-CD49-ARCH-05-OLCF-LUX-CURRENT-SPEC, TDS-WC371-ARCH-05-01
...
- `ARCH-12-U01` **専用アクセラレータ / Specialized accelerators** (`partial`)
  ...
  - Evidence sections: TDS-ARCH02-DOMESTIC, TDS-HC26-ARCH-12-U1, TDS-HW1-ARCH-12-U01, TDS-HW2-ARCH-12-U01, TDS-CD43-ARCH-12-SILICON-PHOTONIC-LEARNING, TDS-CD47-ARCH-12-MAGNETIC-MEMRISTOR, TDS-WC368-ARCH-12-01
...
- `ARCH-12-U03` **導入・供給条件 / Deployment and supply conditions** (`partial`)
  ...
  - Evidence sections: TDS-HW1-ARCH-12-U03, TDS-WC368-ARCH-12-01
...
- `SSW-05-U02` **接続・システム構成 / Connectivity and system organization** (`partial`)
  ...
  - Evidence sections: TDS-HW1-SSW-05-U02, TDS-CD2-SSW-05-U02-U03-U04, TDS-CD41-SSW-05-AOBA-MULTIACCESS-STORAGE, TDS-CD30-SSW-05-CONTEXT-MEMORY-STORAGE, TDS-CD35-SSW-05-KIOXIA-GP1-GPU-FLASH-TIER, TDS-CD40-SSW-05-PCIE6-SSD-ZNANDO, TDS-WC374-SSW-05-01
...
- `SSW-03-U01` **通信と集合通信 / Communication and collectives** (`partial`)
  - MPI・UCX・UCC・集合通信ライブラリの階層ネットワーク・アクセラレータ対応、相互運用性、性能、未対応機能を調査する。
  - Investigate MPI, UCX, UCC, and collective libraries for hierarchical networks, accelerators, interoperability, performance, and missing capabilities.
  - Evidence sections: TDS-SSW03-CURRENT, TDS-SSW03-FUTURE, TDS-HC26-SSW-03-U1, TDS-CD2-SSW-03-U01, TDS-CD3-SSW-03-U01, TDS-CD4-SSW-03-U01, TDS-CD20-SSW-03-MPI5-ABI, TDS-CD21-SSW-03-MPI5-IMPLEMENTATIONS, TDS-WC373-SSW-03-01, TDS-CD52-SSW-03-H3-OPEN-BDEC-2025, TDS-CD14-SSW-03-WAITIO-ROUTER-IMPLEMENTATION, TDS-CD52-SSW-03-AURORA-CORRECTNESS-GATE
...
- `SSW-08-U01` **長期保守と依存リスク / Maintenance and dependency risks** (`partial`)
  ...
  - Evidence sections: TDS-CD1-SSW-08-U01, TDS-CD2-SSW-08-U01, TDS-CD12-SSW-08-U01-U02, TDS-CD13-SSW-08-U01-U02, TDS-CD14-SSW-08-SUSTAINABILITY, TDS-CD19-SSW-08-HPCI-APPLICATION-CONTINUITY, TDS-CD20-SSW-08-FUGAKU-COMMERCIAL-SOFTWARE, TDS-CD68-SSW-08-OPENFOAM-MAINTENANCE, TDS-WC377-SSW-08-01
- `SSW-08-U02` **開発・維持体制 / Development and support models** (`partial`)
  ...
  - Evidence sections: TDS-CD1-SSW-08-U02, TDS-CD2-SSW-08-U02, TDS-CD12-SSW-08-U01-U02, TDS-CD13-SSW-08-U01-U02, TDS-CD14-SSW-08-SUSTAINABILITY, TDS-CD68-SSW-08-OPENFOAM-MAINTENANCE, TDS-WC377-SSW-08-01
...
- `SSW-09-U02` **推論サービング / Inference serving** (`partial`)
  ...
  - Evidence sections: TDS-HC26-SSW-09-U2, TDS-CD6-SSW-09-U02, TDS-CD11-SSW-09-U02-U03, TDS-CD12-SSW-09-U02-U03, TDS-CD55-SSW-09-RIKYU-GENAI-SERVICE, TDS-CD56-SSW-09-OLCF-INFERENCE-SERVICE, TDS-WC378-SSW-09-01
- `SSW-09-U03` **エージェント実行 / Agent execution** (`partial`)
  ...
  - Evidence sections: TDS-CD6-SSW-09-U03, TDS-CD11-SSW-09-U02-U03, TDS-CD12-SSW-09-U02-U03, TDS-CD55-SSW-09-RIKYU-GENAI-SERVICE, TDS-CD56-SSW-09-OLCF-INFERENCE-SERVICE, TDS-CD48-SSW-09-ALCF-AGENT-OPERATIONS, TDS-WC378-SSW-09-01
...
- `APP-02-U02` **性能律速と外挿 / Bottlenecks and extrapolation** (`partial`)
  ...
  - Evidence sections: TDS-SSW07-CURRENT, TDS-SSW07-FUTURE, TDS-CD1-APP-02-U02, TDS-CD3-APP-02-U02, TDS-CD4-APP-02-SP-MIROC-CPU-GPU, TDS-CD50-APP-02-DISCOVERY-CAAR-READINESS, TDS-CD65-APP-02-MD-PORTABILITY-2026, TDS-CD66-APP-02-ELECTRONIC-STRUCTURE-PORTABILITY, TDS-CD67-APP-02-OPENFOAM-GPU-2026, TDS-WC376-APP-02-02, TDS-WC376-APP-02-01
- `APP-02-U03` **継続比較 / Continuous comparison** (`partial`)
  ...
  - Evidence sections: TDS-CD1-APP-02-U03, TDS-CD2-APP-02-U03, TDS-CD3-APP-02-U03, TDS-CD4-APP-02-U03, TDS-CD5-APP-02-U01-U03, TDS-CD34-APP-02-GENKAI-WHOLE-SYSTEM-MEASUREMENT, TDS-CD50-APP-02-DISCOVERY-CAAR-READINESS, TDS-WC376-APP-02-02
...
- `APP-05-U01` **生成・移植・検証 / Generation, porting, and validation** (`partial`)
  - AIによるコード生成・最適化・移植の生産性と正しさを、独立テストと再現可能な課題で評価する。
  - Evaluate productivity and correctness of AI code generation, optimization, and porting using independent tests and reproducible tasks.
  - Evidence sections: TDS-APP05-CURRENT, TDS-APP05-FUTURE, TDS-CD2-APP-05-U01, TDS-CD25-APP-05-CODING-EVAL-QUALITY, TDS-WC382-APP-05-01
...
- `APP-12-U02` **科学AIエージェントの要求 / Scientific-agent requirements** (`partial`)
  ...
  - Evidence sections: TDS-CD1-APP-12-U02, TDS-CD2-APP-12-U02, TDS-CD12-APP-12-U01-U02, TDS-CD15-APP-12-JAPAN-SCIENTIST-AI-JAM, TDS-CD54-APP-12-GENESIS-WORKLOAD-PORTFOLIO, TDS-WC380-APP-12-01
...
- `APP-13-U01` **学習・推論評価 / Training and inference evaluation** (`partial`)
  ...
  - Evidence sections: TDS-AIP-EVALUATION, TDS-HC26-APP-13-U1, TDS-CD2-APP-13-U01, TDS-WC381-APP-13-02, TDS-CD23-APP-13-MLPERF-6, TDS-CD36-APP-13-MLCOMMONS-SCIENCE-MATURITY, TDS-CD37-APP-13-DDP-HOROVOD, TDS-CD46-APP-13-AIST-AI-CHIP-TESTBED, TDS-CD57-APP-13-LLM-INFERENCE-BENCH
- `APP-13-U02` **エージェント・ハーネス評価 / Agent and harness evaluation** (`partial`)
  ...
  - Evidence sections: TDS-AIP-AGENTS, TDS-CD2-APP-13-U02, TDS-CD3-APP-13-U02, TDS-WC381-APP-13-02, TDS-CD20-APP-13-AGENTIC-MATURITY, TDS-CD26-APP-13-GENEBENCH-PRO, TDS-CD27-APP-13-SCIENTIFIC-AGENT-BENCHMARKS-2026, TDS-CD28-APP-13-SGI-ASTABENCH-CONTRACTS
- `APP-13-U03` **負荷モデルと継続測定 / Load models and repeated measurement** (`partial`)
  - Prefill/Decode、到着過程、バッチ、直列区間と同時実行を分離し、資源変更時の予測を独立検証する。
  - Separate prefill/decode, arrival processes, batching, serial work, and concurrency, and independently validate predictions for changed resources.
  - Evidence sections: TDS-AIP-LOAD, TDS-CD4-APP-13-U03, TDS-CD28-APP-13-SGI-ASTABENCH-CONTRACTS, TDS-CD57-APP-13-LLM-INFERENCE-BENCH, TDS-WC381-APP-13-01
...
- `APP-14-U01` **実験・閉ループ処理 / Experiments and closed-loop processing** (`partial`)
  ...
  - Evidence sections: TDS-CD1-APP-14-U01, TDS-CD2-APP-14-U01, TDS-CD3-APP-14-U01, TDS-CD10-APP-14-U01, TDS-CD11-APP-14-JPARC-MLF, TDS-CD12-APP-14-ILIS, TDS-CD13-APP-14-INSTRUMENT-STANDARDS, TDS-CD27-APP-14-EXPERIMENT-SLOS, TDS-CD40-APP-14-NANOTERASU-AOBA, TDS-WC383-APP-14-01
...
- `APP-15-U02` **継続性と再現評価 / Continuity and reproducible evaluation** (`partial`)
  ...
  - Evidence sections: TDS-CD2-APP-15-U02, TDS-CD3-APP-15-U02, TDS-WC388-APP-15-01
...
- `ARCH-06-U01` **設備設計と制約 / Facility design and constraints** (`partial`)
  - 電力枠、冷却方式、設備容量、建屋、運用費と環境制約から実現可能な設備を調査する。
  - Investigate feasible facilities given power envelopes, cooling, capacity, buildings, operating costs, and environmental constraints.
  - Evidence sections: TDS-CD1-ARCH-06-U01, TDS-CD2-ARCH-06-U01, TDS-CD3-ARCH-06-PUE-REGULATION, TDS-CD4-ARCH-06-HIGH-DENSITY-GRID-DYNAMICS, TDS-WC372-ARCH-06-01, TDS-CD45-ARCH-06-AIFS-FACILITY-CONTRACTS, TDS-CD74-ARCH-06-RCCS-UTILITY-OPERATIONS-2025
...
- `ARCH-10-U01` **安定運用と保守 / Reliable operation and maintenance** (`partial`)
  - 信頼性、可用性、保守性、耐障害性、サポート期間、障害監視と更新時の継続性を調査する。
  - Investigate reliability, availability, serviceability, resilience, support lifetimes, fault monitoring, and continuity during renewal.
  - Evidence sections: TDS-CD2-ARCH-10-U01, TDS-CD3-ARCH-10-U01, TDS-CD4-ARCH-10-USER-VISIBLE-INCIDENTS, TDS-WC389-ARCH-10-01, TDS-CD43-ARCH-10-SQUID-CONTROL-PLANE-RAS, TDS-CD46-ARCH-10-TSUKUBA-SERVICE-BOUNDARY, TDS-CD8-ARCH-10-FUGAKU-OPERATIONAL-FAILURES, TDS-CD71-ARCH-10-FUGAKU-MAINTENANCE-2025
...
- `CROSS-03-U01` **全体の運用要件 / Integrated operating requirements** (`partial`)
  - ID、資源配分、転送、ネットワーク、カタログ等の個別技術を参照し、拠点群の一体運用と責任分担を設計する。
  - Use identity, allocation, transfer, network, and catalog technology records to design integrated multi-site operation and responsibilities.
  - Evidence sections: TDS-CD1-CROSS-03-U01, TDS-CD10-CROSS-03-U01, TDS-CD19-CROSS-03-SUPPORT-CAPACITY, TDS-CD29-CROSS-03-AI-USER-OPERATIONS, TDS-CD30-CROSS-03-SUPPORT-OUTCOMES, TDS-CD56-CROSS-03-HPCI-USER-SUPPORT, TDS-CD57-CROSS-03-HPCI-INFORMATION-PATHS, TDS-CD31-CROSS-03-HPCI-SUPPORT-SCALE, TDS-WC384-CROSS-03-01
...
- `CROSS-05-U01` **ハイブリッド運用 / Hybrid operation** (`partial`)
  - 量子資源との接続、予約・スケジューリング、データ経路、運用権限と成熟度条件を調査する。
  - Investigate quantum-resource interfaces, reservations, scheduling, data paths, operational authority, and maturity requirements.
  - Evidence sections: TDS-CD1-CROSS-05-U01, TDS-CD2-CROSS-05-MIYABI-IBM-QUANTUM, TDS-CD8-CROSS-05-QC-HPC-SERVICE-BOUNDARY, TDS-CD8-CROSS-05-EUROHPC-QUANTUM-MATURITY, TDS-CD9-CROSS-05-ROQUO-HYBRID-OPERATIONS, TDS-CD32-CROSS-05-QUERA-LIBRA-HYBRID-OPERATIONS, TDS-CD44-CROSS-05-MOQUREN-PHOTONIC-QC, TDS-WC390-CROSS-05-01
...
- `CROSS-14-U01` **移行と継続運用 / Migration and continuity** (`partial`)
  - 計算機更新と独立したデータ・ID・ワークフローの継続、移行時間、保持方針、責任分担を調査する。
  - Investigate continuity of data, identity, and workflows independently of compute refresh, including migration time, retention, and responsibilities.
  - Evidence sections: TDS-CD1-CROSS-14-U01, TDS-CD2-CROSS-14-U01, TDS-CD3-CROSS-14-U01, TDS-CD11-CROSS-14-FUGAKU-PROJECT-END-DATA, TDS-WC391-CROSS-14-01, TDS-CD17-CROSS-14-SPRING8-GAKUNIN-RDM, TDS-CD18-CROSS-14-SPRING8II-SHUTDOWN, TDS-CD19-CROSS-14-JUPITER-EARLY-ACCESS-JOBS
...
- `CROSS-08-U01` **センター基礎情報 / Center baseline information** (`partial`)
  ...
  - Evidence sections: TDS-CBL-BASELINE, TDS-CBL-CHANGES-V2, TDS-CD1-CROSS-08-U01, TDS-CD10-CROSS-08-U01, TDS-CD11-CROSS-08-U01, TDS-WC387-CROSS-08-01, TDS-CD13-CROSS-08-U01, TDS-CD19-CROSS-08-FY2026-RESOURCE-PORTFOLIO, TDS-CD31-CROSS-08-CENTER-FACILITY-BASELINES, TDS-CD37-CROSS-08-UTOKYO-UTILIZATION, TDS-WC387-CROSS-08-02, TDS-CD42-CROSS-08-SQUID-USE-LIFECYCLE, TDS-CD44-CROSS-08-TSUKUBA-PORTFOLIO, TDS-CD48-CROSS-08-HPCI-FY2026-OFFERED-CAPACITY, TDS-CD20-CROSS-08-HPCI-REQUEST-CAPS, TDS-WC387-CROSS-08-03
- `CROSS-08-U02` **移行・採用条件 / Migration and adoption conditions** (`partial`)
  ...
  - Evidence sections: TDS-CBL-MIGRATION, TDS-CD1-CROSS-08-U02, TDS-CD2-CROSS-08-U02, TDS-CD10-CROSS-08-U01, TDS-WC387-CROSS-08-01, TDS-CD33-CROSS-08-GENKAI-MIGRATION, TDS-WC387-CROSS-08-03
