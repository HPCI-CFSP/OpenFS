...
def shared_units() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "artifact_paths": [*ROADMAP_PATHS, "knowledge/public/audits/roadmap-gap-queue.json", "schemas/roadmap-gap-queue.schema.json", "tools/build_roadmap_gap_queue.py", "tools/run_controller.py", "tools/prepare_weekly_cycle.py"],
        ...
        },
        {
            ...
            "artifact_paths": ["reviews/directives/DIR-900006.json", "config/consensus-policy.json", "config/publication-policy.json", "knowledge/public/audits/roadmap-source-audit.json", "knowledge/public/audits/roadmap-evidence-audit.json", "knowledge/public/audits/roadmap-freshness-audit.json", "knowledge/public/audits/roadmap-gap-queue.json", "schemas/consensus-review-package.schema.json", "schemas/consensus-package-review.schema.json", "schemas/consensus-package-gate-result.schema.json", "schemas/roadmap-freshness-audit.schema.json", "schemas/roadmap-gap-queue.schema.json", "schemas/run.schema.json", "schemas/weekly-cycle.schema.json", "schemas/work-item.schema.json", "schemas/source-receipt.schema.json", "schemas/issue-payload.schema.json", "tools/build_roadmap_freshness_audit.py", "tools/build_roadmap_gap_queue.py", "tools/prepare_freshness_issue.py", "tools/run_controller.py", "tools/prepare_weekly_cycle.py", "tools/register_source.py", "tools/register_no_result.py", "tools/build_pages_site.py", "tools/build_consensus_review_package.py", "tools/evaluate_consensus_review_package.py", ".github/workflows/weekly-review.yml", ".github/workflows/weekly-coordinator.yml", "skills/source-discovery/SKILL.md", "docs/operations/automation-setup.md", "docs/operations/provider-worker-protocol.md", "site/planning.js", "site/roadmap-evidence.html"],
            "selectors": ["DIR-900006", "consensus_status", "research_status", "publication", "ROADMAP-GAP-QUEUE-001", "coverage_gap_refs", "assignment_contract_version"],
            "primary_source_requirements": [],
