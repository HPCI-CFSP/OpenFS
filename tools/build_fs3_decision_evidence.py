...
def build_claim_readiness(chapters: list[dict[str, Any]]) -> list[dict[str, Any]]:
    claims = {
        ...
        "CH-03": ("publishable-with-caveat", "公開一次情報に基づく技術・供給・施設の時系列と、依存関係および未確認事項を提示できます。", "Technology, supply and facility timelines, dependencies and Coverage Gaps based on public primary evidence can be reported.", ["roadmap-consensus", "undated-milestones"], "高影響マイルストーンの時期と依存関係を独立レビューする。", "Independently review high-impact milestone timing and dependencies.", "技術・施設分野の責任者"),
