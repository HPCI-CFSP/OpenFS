...
def report_structure() -> list[dict[str, Any]]:
    values = [
        ...
        ("CH-06", "調達実績とライフサイクル費用", "Procurement evidence and lifecycle cost", "13案件の公表総額、仕様書、費目範囲、5年費用の計算可否を示します。", "Show public totals, specifications, scope coverage, and five-year cost computability for 13 cases.", ["knowledge/public/procurement-cost-register.json", "RM-X-PROCUREMENT"]),
...
def build_artifact() -> dict[str, Any]:
    ...
    return {
        ...
        "summary_ja": "HPCI 27システム、公開調達13案件、EEA1 6アプリ、19ロードマップを、報告書の章構成と追跡可能な形で接続した暫定資料です。未公表値、未校正予測、未承認の閾値は埋めていません。",
        "summary_en": "A provisional package connecting 27 HPCI systems, 13 public procurement cases, six EEA1 applications, and 19 roadmaps to a report structure with traceable evidence. Undisclosed values, uncalibrated forecasts, and unapproved thresholds remain unset.",
        "security_readiness": build_security(),
        "hpci_systems": build_systems(roadmaps),
        "procurements": build_procurements(),
        "eea1": eea1,
        "application_requirements": requirements,
        "roadmaps": build_roadmaps(roadmaps, dependency_register),
...
def render_report(data: dict[str, Any]) -> str:
    ...
    lines += ["", "## 4. 公開調達13案件と5年間費用", "", "| 調達案件 | 公表額 | 仕様書 | 費目根拠 | 60か月費用 | 未確認費目 | 判断への利用 |", "|---|---:|---|---:|---:|---:|---|"]
...
def write_outputs() -> None:
    ...
    report_index = {
        ...
        "reports": [{
            ...
            "summary": "HPCI 27システム、公開調達13案件、EEA1 6アプリ、19ロードマップを、未確認事項を残したまま報告書の章構成へ接続した暫定資料です。",
            "summary_en": "A provisional package connecting 27 HPCI systems, 13 public procurement cases, six EEA1 applications, and 19 roadmaps to a report structure while preserving unresolved evidence.",
