...
REQUIRED_FILES = [
    ...
    "docs/planning/gpu-centric-ai4s-configuration.md",
    ...
    "knowledge/public/gpu-planner-publication.json",
    ...
    "schemas/system-planning-policy-set.schema.json",
    "schemas/reference-architecture.schema.json",
    "schemas/planning-request.schema.json",
    "schemas/gpu-product-catalog.schema.json",
    "schemas/procurement-availability-assessment.schema.json",
    "schemas/component-cost-input.schema.json",
    "schemas/configuration-estimate.schema.json",
    ...
    "schemas/gpu-planner-publication.schema.json",
    ...
    "tools/estimate_gpu_centric_configuration.py",
    ...
    "site/index.html",
    "site/styles.css",
    "site/gpu-planner-engine.js",
    "site/gpu-planner-candidate.html",
    "site/analytics.js",
    "site/privacy.html",
    "site/app.js",
