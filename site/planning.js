(function () {
  ...
  const copy = {
    ja: {
      ...
      normalizedDependenciesTitle: "整理した相互依存関係", externalConstraintsTitle: "外部制約と未確認事項", portfolioGateTitle: "計画全体の判断ゲート", portfolioGateNote: "ここに示す項目は、個別ロードマップ間の因果関係ではありません。6本のロードマップを統合して正式判断する前に、計画全体で解消すべき未確認事項です。", sourceCount: "情報源", sourceRegistrations: "情報源の登録数", uniqueSourceUrls: "重複を除いたURL数", duplicateRegistrations: "重複登録数", externalUrls: "外部URL数", externalFirstParty: "外部の一次・公式情報", standardsUnit: "標準化団体", vendorsUnit: "ベンダー", openfsGovernance: "OpenFSの運用記録", internalGovernanceEvent: "内部の運用記録", internalGovernanceNote: "外部技術の根拠には含めない", reachable: "到達可能", accessRestricted: "アクセス制限", timeoutError: "タイムアウト／エラー", milestoneCount: "マイルストーン", primaryEvent: "出来事・標準", forwardTarget: "将来目標", baseline: "情報確認日時点", coverageGap: "時期未公表", provisionalGate: "OpenFS暫定判断ゲート", sourceQuarterPrecision: "外部根拠のある四半期", provisionalQuarterPrecision: "暫定的な四半期", lowerPrecision: "半期・年単位",
