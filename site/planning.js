(function () {
  ...
  const copy = {
    ja: {
      ...
      navOverview: "概要", navCatalog: "調査カタログ", navRoadmaps: "ロードマップ", navScenarios: "システム整備計画案", navReports: "報告書", footerDescription: "HPCI-CFSP 公開調査ビュー",
      ...
      claimAuditTitle: "Claim-Evidence監査", sourceAuditTitle: "情報源到達性", sourceAuditNote: "到達性は主張の正しさを示しません。アクセス制限やtimeoutはブラウザで有効な資料でも発生します。重複除去URL数も独立した情報起源数ではなく、意味取得の再確認も単一モデルによる暫定結果です。", sourceClassTitle: "情報源クラスの内訳", sourceClassNote: "クラス別件数はロードマップ別の登録数です。同一URLの重複除去件数は上部に分けて表示します。一次・公式情報であることは、個々の主張が独立に検証済みであることを意味しません。", sourceClass: "情報源クラス", sourceClassMeaning: "この分類が示すもの", retrievalAttentionTitle: "到達性に注意が必要な情報源", "vendor-official": "ベンダー公式", "standards-body": "標準化団体", "government-official": "政府・公的機関", "research-organization": "研究機関", "project-official": "公式プロジェクト", "academic-primary": "一次学術論文", "openfs-governance": "OpenFSガバナンス", "vendor-officialMeaning": "製品、出荷、企業ロードマップの発表主体", "standards-bodyMeaning": "仕様、標準化段階、公開版の発行主体", "government-officialMeaning": "政策、調達、施設・事業計画の公的発行主体", "research-organizationMeaning": "研究開発計画、実証、システム運用の実施主体", "project-officialMeaning": "OSS、ベンチマーク、共同開発計画の公式発行主体", "academic-primaryMeaning": "著者が方法と結果を報告する原著論文", "openfs-governanceMeaning": "外部技術根拠ではなくOpenFS自身の暫定判断・手続", retrievalTriage: "意味取得トリアージ", exactUrlConfirmed: "同一URL本文を確認", unresolvedRetrieval: "未解決",
      freshnessAuditTitle: "更新時期・再調査キュー", freshnessAuditLead: "公開日・更新日が古いことだけで誤りとはみなさず、時期未確定、期限経過、到達性注意、日付情報不足を次回ループへ送ります。", freshnessAttentionTitle: "更新確認が必要な項目", freshnessAttention: "高優先度の更新確認", critical: "重大", object: "対象", reason: "理由",
      gapRegisterTitle: "優先度付きCoverage Gap", gapRegisterLead: "公開情報で確認できない条件を推測で補わず、判断への影響と次の調査行動を記録します。",
      centerProfileTitle: "HPCIセンターProfile監査", centerProfileLead: "検索実行、項目ごとの根拠、Consensus受理を分け、GAP-BLUE-001/003を推測で閉じないための監査です。", profileFieldCoverage: "12項目の証拠状態", centerProfileStatus: "センター別の暫定状態", acceptedProfiles: "受理済みProfile", evidenceCompleteProfiles: "全項目根拠あり", effectiveQueries: "改善した追跡query", verifiedFields: "確認済み項目", partialFields: "部分確認", unknownFields: "未確認", notCollectedFields: "旧契約で未収集", profileField: "Profile項目", centerName: "センター", profileDecision: "受理状態", fieldSummary: "項目状態", officialPage: "公式サイト", verified: "確認済み", partial: "部分確認", unknown: "未確認", "not-collected": "未収集", unaccepted: "未受理", acceptedCurrent: "受理済み・現行", profile_users: "利用者", profile_priority_domains: "重点分野", profile_current_system: "現行システム", profile_refresh_window: "更新時期", profile_power: "電力", profile_facility: "施設", profile_budget: "予算", profile_procurement: "調達", profile_software: "ソフトウェア", profile_operations: "運用", profile_migration: "移行", profile_data_connectivity: "データ接続性",
      gapQueueTitle: "P0調査割当キュー", gapQueueLead: "P0 Gapを調査Monitorまたは独立Consensusへ割り当て、検索計画と閉鎖条件を分けて示します。全条件、独立起源数、Consensusを満たすまで未解決です。", assignment: "割当先", cadence: "再確認頻度", executionState: "実行状態", queryPlan: "検索計画", closurePlan: "閉鎖条件", closureCriteria: "条件", independentOrigins: "独立起源", consensusRequired: "Consensus必須", criteriaUnverified: "条件未検証", weekly: "毎週", monthly: "毎月", quarterly: "四半期", "continuous-until-quorum": "定足数まで継続", "staged-monitor-disabled": "Monitor無効・準備待ち", "ready-for-scheduled-discovery": "定期調査可能", "awaiting-independent-review": "独立レビュー待ち", "explicit-override": "明示query", "generated-fallback": "生成fallback", "not-applicable": "対象外", assignedDiscovery: "情報探索割当", assignedConsensus: "Consensus割当", productionReady: "定期実行可能", p0ExplicitQueries: "P0明示query", p0FallbackQueries: "P0 fallback",
      normalizedDependenciesTitle: "正規化した相互依存", externalConstraintsTitle: "外部制約・Coverage Gap", portfolioGateTitle: "ポートフォリオ全体の判断ゲート", portfolioGateNote: "因果関係を示すエッジではありません。6本を統合して正式判断する前に、ポートフォリオ全体で解消すべき未確認事項です。", sourceCount: "情報源", sourceRegistrations: "情報源登録", uniqueSourceUrls: "重複除去URL", duplicateRegistrations: "重複登録", externalUrls: "外部URL", externalFirstParty: "外部一次・公式情報登録", openfsGovernance: "OpenFSガバナンス", internalGovernanceEvent: "内部ガバナンス記録", internalGovernanceNote: "外部技術根拠には不算入", reachable: "到達", accessRestricted: "アクセス制限", timeoutError: "timeout / error", milestoneCount: "マイルストーン", primaryEvent: "出来事・標準", forwardTarget: "将来目標", baseline: "基準日時点", coverageGap: "時期未公表", provisionalGate: "OpenFS暫定ゲート", sourceQuarterPrecision: "外部根拠付き四半期", provisionalQuarterPrecision: "暫定四半期", lowerPrecision: "半期・年単位",
      ...
      scenarioKicker: "SYSTEM PLANNING OPTIONS", scenarioIndexTitle: "システム整備計画案 3案比較", scenarioIndexLead: "同じ11評価軸、判断ゲート、時間軸で比較し、未確認条件を推測で埋めずに残します。",
      notRanking: "推奨順位ではありません", scenarioNotice: "3案はいずれも単一モデルによる暫定案で、センターProfile、価格、供給、施設条件、Consensusが未完了です。",
      scenarioComparisonTitle: "共通形式で比較", commonDecisionGates: "共通判断ゲート", objective: "目的", architecture: "アーキテクチャ", systemSoftware: "システムソフトウェア", applications: "アプリケーション", unknownCount: "未確認条件", reversibility: "可逆性", openDetail: "詳細を見る", budgetArchitectureTitle: "予算規模別のシステムアーキテクチャ案", budgetArchitectureLead: "梅・竹・松を切り替え、概算予算内で構成する場合の規模と接続関係を比較します。竹を基準案とします。", budgetArchitectureControl: "予算規模", budgetRange: "概算事業規模", analyticalEstimate: "OpenFS分析値", lowConfidence: "確信度: 低", cpuNodes: "CPUノード", acceleratorNodes: "アクセラレータノード", accelerators: "アクセラレータ", storageCapacity: "共有ストレージ", facilityClass: "施設規模", component: "構成要素", quantity: "概算規模", role: "役割", budgetReferenceCases: "予算・構成の公開参照例", referenceBudget: "公表規模", notPublished: "非公表", comparabilityNote: "比較上の注意", estimateMethod: "推定方法",
      planningHorizon: "計画期間", researchStatus: "調査状態", consensusStatus: "Consensus", updatedColumn: "更新日時", provisional: "暫定", incomplete: "未完了", implementationTimelineTitle: "計画案の時間的な展開", implementationTimelineLead: "各案が調査・実証から導入・展開へ進む想定を四半期単位で示します。すべてOpenFSの暫定計画であり、外部製品の確定日程ではありません。", implementationTimelineDetailLead: "分野別の調査、実証、判断、導入、展開を四半期単位で示します。各帯の期間はOpenFSの暫定計画です。", contextNotesTitle: "適用範囲に関する注記", hpciSpecific: "HPCI固有", reusable: "一般化可能", planVersion: "計画案の版", effectiveFrom: "適用開始日", reviewDue: "次回見直し期限", supersedes: "置換前の版", noSupersededVersion: "初版", timelineDomain: "分野", timelineQuarter: "四半期", stageResearch: "調査", stageEvaluation: "評価", stagePilot: "実証", stageDecision: "判断", stageDeployment: "導入", stageExpansion: "展開", stageOperation: "運用", stageRetirement: "更新・終了", portfolio: "計画全体", "storage-data": "ストレージ・データ", "facility-operations": "施設・運用", "procurement-governance": "調達・ガバナンス",
      centerImpacts: "センターへの影響", technologyOptions: "技術候補とfallback", decisionEvidenceContracts: "判断に必要な検証契約", decisionEvidenceContractsNote: "各契約の検証に合格してもConsensus候補になるだけで、自動採用されません。", coveredGaps: "対象P0 Gap", schemas: "Schema", validators: "Validator", acceptanceEffect: "効力", candidateOnly: "Consensus候補まで", evaluationAxes: "11評価軸", unscoredNote: "人が重みを承認していないため総合点は付けません。", decisionBlockingGaps: "正式判断を止めるP0 Gap", decisionBlockingGapsNote: "候補の比較は続けられますが、正式な推奨・採用には解消または記録付きの扱い決定が必要です。", uncertainties: "未確認条件", decisionGates: "判断ゲート", provenance: "PROVENANCE", traceability: "来歴と参照ID", sourceCommit: "ソースコミット",
      ...
      consensusReview: "Consensusレビュー", consensusIndexTitle: "Consensusレビュー", consensusIndexLead: "固定コミット、独立性要件、決定論的ゲート、有効なReviewerの来歴を表示します。", consensusNotAcceptance: "レビュー完了は自動採用ではありません", consensusIndexNotice: "高影響のHPCI判断は、独立レビュー閾値を満たした後も人のDirectiveを必要とします。", openConsensus: "レビュー来歴を見る", consensusRequirements: "独立レビュー要件", consensusReviewUnits: "レビュー単位", eligibleReviewers: "有効なReviewer", unmetRequirements: "未達要件", knownLimitations: "既知の制約", noEligibleReviewers: "現在、有効な独立Reviewはありません。", assessmentCount: "有効Review", supportCount: "支持", modelFamilies: "モデル系統", providers: "プロバイダ", harnesses: "Harness系統", criticReviews: "反証Review", pinnedArtifacts: "固定成果物", baseCommit: "固定コミット", manifestDigest: "Manifest SHA-256", requirement: "要件", threshold: "閾値", reviewChecks: "検査項目", reviewer: "Reviewer", model: "モデル", harness: "Harness", verdict: "判定", reviewedAt: "レビュー日時", "ready-for-human-decision": "人の判断待ち", awaiting: "独立レビュー待ち", gateEffectIncomplete: "独立レビューの要件は未達です。ロードマップとシステム整備計画案は暫定のままです。", gateEffectReady: "独立レビュー閾値を満たしましたが、採用には人の判断が必要です。"
    },
    en: {
      ...
      navOverview: "Overview", navCatalog: "Research catalog", navRoadmaps: "Roadmaps", navScenarios: "System planning options", navReports: "Reports", footerDescription: "HPCI-CFSP public research view",
      ...
      claimAuditTitle: "Claim-evidence audit", sourceAuditTitle: "Source reachability", sourceAuditNote: "Reachability does not validate claims. A browser-accessible source may still return an access restriction or timeout to the machine client. Unique URL count is not independent-origin count, and semantic retrieval follow-up is provisional single-model work.", sourceClassTitle: "Source-class breakdown", sourceClassNote: "Class counts are roadmap registrations. The deduplicated URL count is shown separately above. First-party or official provenance does not mean that each claim has been independently verified.", sourceClass: "Source class", sourceClassMeaning: "What this classification establishes", retrievalAttentionTitle: "Sources requiring reachability attention", "vendor-official": "Vendor official", "standards-body": "Standards body", "government-official": "Government / public body", "research-organization": "Research organization", "project-official": "Official project", "academic-primary": "Primary academic paper", "openfs-governance": "OpenFS governance", "vendor-officialMeaning": "Publisher responsible for product, shipment, or corporate-roadmap statements", "standards-bodyMeaning": "Publisher responsible for specifications, standards stages, or releases", "government-officialMeaning": "Public authority responsible for policy, procurement, facilities, or programs", "research-organizationMeaning": "Organization responsible for R&D plans, demonstrations, or system operation", "project-officialMeaning": "Official publisher for an OSS, benchmark, or collaborative project", "academic-primaryMeaning": "Original paper whose authors report methods and results", "openfs-governanceMeaning": "OpenFS procedure or provisional judgment, not external technology evidence", retrievalTriage: "Semantic retrieval triage", exactUrlConfirmed: "exact URL content confirmed", unresolvedRetrieval: "unresolved",
      freshnessAuditTitle: "Freshness and follow-up queue", freshnessAuditLead: "Queues undated timing, passed targets, reachability warnings, and missing date metadata without treating age as error.", freshnessAttentionTitle: "Medium-or-higher attention", freshnessAttention: "High-priority freshness attention", critical: "critical", object: "Object", reason: "Reason",
      ...
      centerProfileTitle: "HPCI center-profile assurance", centerProfileLead: "Separates search execution, field evidence, and Consensus acceptance so GAP-BLUE-001/003 cannot be closed by inference.", profileFieldCoverage: "Evidence state across twelve fields", centerProfileStatus: "Provisional status by center", acceptedProfiles: "Accepted profiles", evidenceCompleteProfiles: "All fields evidenced", effectiveQueries: "Effective follow-up queries", verifiedFields: "Verified fields", partialFields: "Partially verified", unknownFields: "Unknown", notCollectedFields: "Absent from old contract", profileField: "Profile field", centerName: "Center", profileDecision: "Acceptance", fieldSummary: "Field states", officialPage: "Official site", verified: "verified", partial: "partial", unknown: "unknown", "not-collected": "not collected", unaccepted: "unaccepted", acceptedCurrent: "accepted and current", profile_users: "Users", profile_priority_domains: "Priority domains", profile_current_system: "Current system", profile_refresh_window: "Refresh window", profile_power: "Power", profile_facility: "Facility", profile_budget: "Budget", profile_procurement: "Procurement", profile_software: "Software", profile_operations: "Operations", profile_migration: "Migration", profile_data_connectivity: "Data connectivity",
      gapQueueTitle: "P0 research assignment queue", gapQueueLead: "Assigns each P0 Gap to a research Monitor or independent Consensus and separates query plans from closure contracts. A Gap remains open until every criterion, independent-origin minimum, and Consensus requirement passes.", assignment: "Assignment", cadence: "Recheck cadence", executionState: "Execution state", queryPlan: "Query plan", closurePlan: "Closure criteria", closureCriteria: "criteria", independentOrigins: "independent origins", consensusRequired: "Consensus required", criteriaUnverified: "criteria unverified", weekly: "weekly", monthly: "monthly", quarterly: "quarterly", "continuous-until-quorum": "until quorum", "staged-monitor-disabled": "Monitor disabled; staged", "ready-for-scheduled-discovery": "scheduled discovery ready", "awaiting-independent-review": "awaiting independent review", "explicit-override": "explicit queries", "generated-fallback": "generated fallback", "not-applicable": "not applicable", assignedDiscovery: "Discovery assignments", assignedConsensus: "Consensus assignments", productionReady: "Scheduled-ready", p0ExplicitQueries: "P0 explicit queries", p0FallbackQueries: "P0 fallbacks",
      normalizedDependenciesTitle: "Normalized dependencies", externalConstraintsTitle: "External constraints and Coverage Gaps", portfolioGateTitle: "Portfolio-wide decision gate", portfolioGateNote: "This is not a causal dependency edge. It is an unresolved condition that applies to the whole portfolio before the six roadmaps can support a formal decision.", sourceCount: "Sources", sourceRegistrations: "Source registrations", uniqueSourceUrls: "Unique source URLs", duplicateRegistrations: "duplicate registrations", externalUrls: "external URLs", externalFirstParty: "External first-party registrations", openfsGovernance: "OpenFS governance", internalGovernanceEvent: "Internal governance record", internalGovernanceNote: "Excluded from external technology evidence", reachable: "Reachable", accessRestricted: "Access restricted", timeoutError: "Timeout / error", milestoneCount: "Milestones", primaryEvent: "Events / standards", forwardTarget: "Forward targets", baseline: "As-of baseline", coverageGap: "Undated", provisionalGate: "OpenFS provisional gates", sourceQuarterPrecision: "External source-backed quarter", provisionalQuarterPrecision: "Provisional quarter", lowerPrecision: "Half-year / year",
      ...
      scenarioComparisonTitle: "Common-format comparison", commonDecisionGates: "Common decision gates", objective: "Objective", architecture: "Architecture", systemSoftware: "System Software", applications: "Applications", unknownCount: "Unknown conditions", reversibility: "Reversibility", openDetail: "Open details", budgetArchitectureTitle: "Budget-scaled system architecture options", budgetArchitectureLead: "Switch among Ume, Take, and Matsu to compare estimated system scale and connectivity within each budget class. Take is the reference option.", budgetArchitectureControl: "Budget class", budgetRange: "Estimated program scale", analyticalEstimate: "OpenFS analytical estimate", lowConfidence: "confidence: low", cpuNodes: "CPU nodes", acceleratorNodes: "Accelerator nodes", accelerators: "Accelerators", storageCapacity: "Shared storage", facilityClass: "Facility class", component: "Component", quantity: "Estimated scale", role: "Role", budgetReferenceCases: "Public budget and topology reference cases", referenceBudget: "Published scale", notPublished: "not published", comparabilityNote: "Comparability note", estimateMethod: "Estimation method",
      planningHorizon: "Planning horizon", researchStatus: "Research status", consensusStatus: "Consensus", updatedColumn: "Updated", provisional: "provisional", incomplete: "incomplete", implementationTimelineTitle: "Time-phased implementation path", implementationTimelineLead: "Shows how each option could progress from research and pilots to deployment and expansion by quarter. All bands are provisional OpenFS plans, not confirmed external product schedules.", implementationTimelineDetailLead: "Shows research, evaluation, decisions, deployment, and expansion by domain and quarter. Each band is a provisional OpenFS plan.", contextNotesTitle: "Scope notes", hpciSpecific: "HPCI-specific", reusable: "Reusable", planVersion: "Plan version", effectiveFrom: "Effective from", reviewDue: "Review due", supersedes: "Supersedes", noSupersededVersion: "initial version", timelineDomain: "Domain", timelineQuarter: "Quarter", stageResearch: "research", stageEvaluation: "evaluation", stagePilot: "pilot", stageDecision: "decision", stageDeployment: "deployment", stageExpansion: "expansion", stageOperation: "operation", stageRetirement: "renewal / retirement", portfolio: "Overall plan", "storage-data": "Storage and data", "facility-operations": "Facilities and operations", "procurement-governance": "Procurement and governance",
      centerImpacts: "Center impacts", technologyOptions: "Technology options and fallback", decisionEvidenceContracts: "Decision evidence contracts", decisionEvidenceContractsNote: "Passing a contract only makes the result a Consensus candidate; it does not trigger automatic adoption.", coveredGaps: "Covered P0 Gaps", schemas: "Schemas", validators: "Validators", acceptanceEffect: "Effect", candidateOnly: "Consensus candidate only", evaluationAxes: "Eleven evaluation criteria", unscoredNote: "No total score is calculated before human approval of weights.", decisionBlockingGaps: "P0 Gaps blocking a formal decision", decisionBlockingGapsNote: "Candidate comparison can continue, but formal recommendation or adoption requires resolution or a recorded disposition.", uncertainties: "Uncertainties", decisionGates: "Decision gates", provenance: "PROVENANCE", traceability: "Traceability and references", sourceCommit: "Source commit",
  ...
  function renderEvidencePage() {
    ...
    renderMetric(metrics, tr("uniqueSourceUrls"), source.summary.unique_url_count, `${source.summary.unique_external_url_count} ${tr("externalUrls")} · ${source.audit_id}`);
    renderMetric(metrics, tr("externalFirstParty"), source.summary.external_first_party_source_count, `${source.summary.source_class_counts["standards-body"]} standards · ${source.summary.source_class_counts["vendor-official"]} vendors`);
