(function () {
  ...
  function renderEvidencePage() {
    ...
    [["evidence-audit-commit", evidence], ["freshness-audit-commit", freshness], ["gap-queue-commit", gapQueue], ["source-audit-commit", source], ["dependency-register-commit", dependencies]].forEach(([id, artifact]) => { const link = document.getElementById(id); link.href = artifact.source_commit_url; link.textContent = `${tr("commit")} ${artifact.source_commit.slice(0, 7)}`; });
