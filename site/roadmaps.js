(function () {
  ...
  function renderHPCIInventory(roadmap) {
    ...
    const operationalLabels = language === "ja"
      ? {title: "公開された運用実績", lead: "定義、集計期間、除外条件を保持し、異なる提供機関の値をそのまま順位付けしません。", system: "システム", metric: "指標", period: "期間", value: "公表値", basis: "定義・比較上の注意", designPower: "設計電力", operatingPower: "通常運用電力", utilization: "利用率", jobCount: "ジョブ件数", maximumJobDuration: "最大連続実行時間", products: "公開運用データ", records: "概数", dataset: "公開データセット", chart: "公開グラフ"}
      : {title: "Published operational evidence", lead: "Definitions, periods and exclusions are preserved; values from different providers are not used directly as a ranking.", system: "System", metric: "Metric", period: "Period", value: "Published value", basis: "Definition and comparability", designPower: "Design power", operatingPower: "Normal-operation power", utilization: "Utilization", jobCount: "Job count", maximumJobDuration: "Maximum continuous run time", products: "Public operational data", records: "approx. records", dataset: "Public dataset", chart: "Published chart"};
    ...
    const operationalBody = document.createElement("tbody"); const metricLabels = {"design-power": operationalLabels.designPower, "operating-power": operationalLabels.operatingPower, utilization: operationalLabels.utilization, "job-count": operationalLabels.jobCount, "maximum-job-duration": operationalLabels.maximumJobDuration};
