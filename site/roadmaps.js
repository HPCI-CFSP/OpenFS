(function () {
  ...
  const copy = {
    ja: {
      ...
      roadmapKicker: "根拠付き暫定ロードマップ", roadmapFilter: "トラック群フィルタ", trackColumn: "技術・判断トラック", ownerColumn: "主体／対象", quarterUnknown: "四半期未公表", undatedColumn: "時期未公表", roadmapTableNote: "世代見通しは標準・製品情報を統合した暫定的な帯で、重複を許します。通常の矩形は公開情報が許す時期の範囲を示します。年のみ公表された項目はQ1-Q4、半期は該当する2四半期にまたがり、継続期間を意味しません。空欄は日程未確認です。",
      ...
      timingBasis: "時期の根拠", timingPrecision: "時期の精度", eventType: "イベント種別", quarterPrecision: "四半期", halfYearPrecision: "半期", yearPrecision: "年", undatedPrecision: "未公表", milestoneDetail: "マイルストーン詳細", generationBandDetail: "世代見通し詳細", publicSources: "公開根拠資料",
      observed: "確認済み", asOfBaseline: "基準日時点の提供状況", standardRelease: "標準公開", vendorTarget: "ベンダー目標", projectTarget: "プロジェクト目標", policyTarget: "政策目標", openfsPlan: "OpenFS暫定計画", openfsSynthesis: "OpenFS統合判断", noPublicDate: "公開時期なし",
      generationOutlook: "世代見通し（暫定）", generationPhase: "世代フェーズ", confidence: "確度", highConfidence: "高", mediumConfidence: "中", lowConfidence: "低", openEnded: "終了時期未確認", standardizationPhase: "標準化", introductionPhase: "導入", mainstreamPhase: "主流", transitionPhase: "移行", continuingPhase: "継続", generationWindowNote: "世代帯は複数の公開情報を統合した時期窓です。世代間の重複を許し、終了時期未確認の矢印は表示期間後も続く可能性を示します。",
    ...
    en: {
      ...
      timingBasis: "Timing basis", timingPrecision: "Timing precision", eventType: "Event type", quarterPrecision: "quarter", halfYearPrecision: "half-year", yearPrecision: "year", undatedPrecision: "not public", milestoneDetail: "Milestone detail", generationBandDetail: "Generation outlook detail", publicSources: "Public supporting sources",
