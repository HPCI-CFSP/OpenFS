(function () {
  ...
  const copy = {
    ja: {
      ...
      topicsMetric: "調査Topic", topicsMetricNote: "保護された初期項目を含む", technologyMetric: "技術領域",
      technologyMetricNote: "継続調査対象", scenarioMetric: "公開シナリオ", scenarioMetricNote: "人の公開承認を通過した成果",
      ...
      technologyLead: "HPCIの整備計画に関係する技術を領域別に継続調査し、根拠・成熟度・導入条件を整理します。",
      scenarioKicker: "ロードマップシナリオ", scenarioTitle: "HPCI整備シナリオ",
      scenarioLead: "Architecture、System Software、Applications、センターへの影響、技術選択肢、不確実性を一体で比較します。",
    ...
    en: {
      ...
      topicsMetric: "Research topics", topicsMetricNote: "Includes the protected initial catalog", technologyMetric: "Technology areas",
      technologyMetricNote: "Continuously monitored", scenarioMetric: "Published scenarios", scenarioMetricNote: "Passed explicit human publication approval",
      ...
      noTopics: "No topics match the current filters.", technologyKicker: "CONTINUOUS RESEARCH SCOPE", technologyTitle: "Technology landscape", area: "AREA",
      technologyLead: "Continuously track technologies relevant to HPCI infrastructure planning and organize their evidence, maturity, and deployment conditions.", scenarioKicker: "ROADMAP SCENARIOS",
      scenarioTitle: "HPCI infrastructure scenarios",
      scenarioLead: "Compare architecture, system software, applications, center impacts, technology options, and uncertainties as a coherent whole.",
  ...
  function renderSummary() {
    ...
    setText("metric-technology-areas", data.technology_landscape.categories.length);
