(function () {
  ...
  const copy = {
    ja: {
      ...
      scenarioKicker: "システム整備計画案", scenarioIndexTitle: "CPU・GPU複合計算基盤", scenarioIndexLead: "予算と受入時期を起点に、調達実績を確認できる候補と、公式ロードマップ上の先行候補を分けて検討します。",
    ...
    en: {
      ...
      scenarioKicker: "SYSTEM PLANNING OPTIONS", scenarioIndexTitle: "CPU-GPU Accelerated Computing Infrastructure", scenarioIndexLead: "Start with budget and acceptance timing, then assess procurement-evidenced candidates separately from forward-looking candidates on official roadmaps.",
