(function () {
  ...
  const copy = {
    ja: {
      ...
      footer: "HPCI-CFSP 公開調査ビュー", navOverview: "概要", navCatalog: "調査カタログ", navOperational: "ソフトウェア利用調査", navRoadmaps: "ロードマップ", navScenarios: "システム整備計画案", navReports: "報告書", navGlossary: "専門用語", navSearch: "検索",
    ...
    en: {
      ...
      footer: "HPCI-CFSP public research view", navOverview: "Overview", navCatalog: "Research catalog", navOperational: "Software usage survey", navRoadmaps: "Roadmaps", navScenarios: "System planning options", navReports: "Reports", navGlossary: "Glossary", navSearch: "Search",
