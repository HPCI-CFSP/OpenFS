...
class PagesSiteTests(unittest.TestCase):
    ...
    def write_roadmap_fixture(self, root):
        ...
        for name in ("DIR-900004.json", "DIR-900005.json", "DIR-900013.json", "DIR-900015.json", "DIR-900016.json", "DIR-900017.json", "DIR-900018.json", "DIR-900019.json", "DIR-900025.json", "DIR-900026.json", "DIR-900027.json", "DIR-900100.json", "DIR-900103.json", "DIR-900104.json"):
    ...
    def test_build_publishes_catalog_and_approved_scenarios_only(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertNotIn("renderRegionFilter", app)
            self.assertIn("renderStructuredTopicLayout", app)
