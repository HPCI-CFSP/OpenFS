...
3 provisional HPCI scenarios to commit `f706a843b06077b0ef6c66b1cd807ddfd4966380`.

## Review protocol

1. Check out exactly `f706a843b06077b0ef6c66b1cd807ddfd4966380` and verify every `artifact_manifest.sha256`.
...
HPCI整備計画3案をコミット `f706a843b06077b0ef6c66b1cd807ddfd4966380` に固定します。
