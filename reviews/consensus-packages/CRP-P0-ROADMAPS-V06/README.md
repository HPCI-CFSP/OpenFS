# CRP-P0-ROADMAPS-V06 independent review package
...
3 provisional HPCI scenarios to commit `23d9d26c943a9a1c8f8acb7265db18764611f010`.

## Review protocol

1. Check out exactly `23d9d26c943a9a1c8f8acb7265db18764611f010`, verify every `artifact_manifest.sha256`, and
...
4. Fill `review-template.json`, remove `_template_notice`, assign a unique review
   ID, and save it under `assessments/CRP-P0-ROADMAPS-V06/`. Do not edit the package manifest.
...
HPCI整備計画3案をコミット `23d9d26c943a9a1c8f8acb7265db18764611f010` に固定します。
