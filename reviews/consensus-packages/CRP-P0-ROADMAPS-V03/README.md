# CRP-P0-ROADMAPS-V03 independent review package
...
3 provisional HPCI scenarios to commit `323303bad4e1ddaf31ff82560b452e15ab3eb8af`.

## Review protocol

1. Check out exactly `323303bad4e1ddaf31ff82560b452e15ab3eb8af`, verify every `artifact_manifest.sha256`, and
...
4. Fill `review-template.json`, remove `_template_notice`, assign a unique review
   ID, and save it under `assessments/CRP-P0-ROADMAPS-V03/`. Do not edit the package manifest.
...
HPCI整備計画3案をコミット `323303bad4e1ddaf31ff82560b452e15ab3eb8af` に固定します。
