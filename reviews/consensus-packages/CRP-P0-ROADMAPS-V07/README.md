# CRP-P0-ROADMAPS-V07 independent review package

This package pins 19 P0 roadmaps, 387
...
3 provisional HPCI scenarios to commit `1a01b09054e6e1cc737df1d1a02890b461bf01ee`.

## Review protocol

1. Check out exactly `1a01b09054e6e1cc737df1d1a02890b461bf01ee`, verify every `artifact_manifest.sha256`, and
...
4. Fill `review-template.json`, remove `_template_notice`, assign a unique review
   ID, and save it under `assessments/CRP-P0-ROADMAPS-V07/`. Do not edit the package manifest.
...
HPCI整備計画3案をコミット `1a01b09054e6e1cc737df1d1a02890b461bf01ee` に固定します。
